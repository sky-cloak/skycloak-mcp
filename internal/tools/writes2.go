...
func registerWrites2Tools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_realm_role", Description: "Rename a realm role or change its description.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update realm role"}}, updateRealmRoleHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_realm_group", Description: "Rename a realm group.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update realm group"}}, updateRealmGroupHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_realm_user", Description: "Update a realm user's profile (email, name, enabled, email_verified).", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update realm user"}}, updateRealmUserHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_domain_route", Description: "Update a domain route's admin access and CORS origins.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update domain route"}}, updateDomainRouteHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_application", Description: "Update an application's name, description, or redirect URIs.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update application"}}, updateApplicationHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_identity_provider", Description: "Update an identity provider's display name and enabled state.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update identity provider"}}, updateIdentityProviderHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_cluster", Description: "Update a cluster's version (to trigger an upgrade) or size.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update cluster"}}, updateClusterHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_extension", Description: "Update a custom extension's name or description.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update extension"}}, updateExtensionHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_update_theme", Description: "Update a theme's name, description, or version.", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Update theme"}}, updateThemeHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_upsert_smtp", Description: "Create or update a realm's SMTP configuration (basic auth).", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Upsert SMTP"}}, upsertSMTPHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_upsert_login_branding", Description: "Create or update login-page branding (colors, logo, registration toggle).", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Upsert login branding"}}, upsertLoginBrandingHandler(api))
	mcp.AddTool(s, &mcp.Tool{Name: "skycloak_upsert_email_branding", Description: "Create or update email-template branding (color, logo, footer).", Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, IdempotentHint: true, Title: "Upsert email branding"}}, upsertEmailBrandingHandler(api))
