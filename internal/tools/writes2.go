...
func registerWrites2Tools(s *mcp.Server, api API) {
	addTool(s, &mcp.Tool{Name: "skycloak_update_realm_role", Description: "Rename a realm role or change its description.", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update realm role"}}, updateRealmRoleHandler(api))
	addTool(s, &mcp.Tool{Name: "skycloak_update_realm_group", Description: "Rename a realm group.", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update realm group"}}, updateRealmGroupHandler(api))
	addTool(s, &mcp.Tool{Name: "skycloak_update_realm_user", Description: "Update a realm user's profile (email, name, enabled, email_verified).", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update realm user"}}, updateRealmUserHandler(api))
	addTool(s, &mcp.Tool{Name: "skycloak_update_domain_route", Description: "Update a domain route's admin access and CORS origins.", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update domain route"}}, updateDomainRouteHandler(api))
	addTool(s, &mcp.Tool{Name: "skycloak_update_application", Description: "Update an application's name, description, or redirect URIs.", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update application"}}, updateApplicationHandler(api))
	addTool(s, &mcp.Tool{Name: "skycloak_update_identity_provider", Description: "Update an identity provider's display name and enabled state.", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update identity provider"}}, updateIdentityProviderHandler(api))
	addTool(s, &mcp.Tool{Name: "skycloak_update_cluster", Description: "Update a cluster's version (to trigger an upgrade) or size.", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update cluster"}}, updateClusterHandler(api))
	...
	addTool(s, &mcp.Tool{Name: "skycloak_update_theme", Description: "Update a theme's name, description, or version. Metadata only: use skycloak_update_theme_content to replace the theme's archive.", Annotations: &mcp.ToolAnnotations{OpenWorldHint: ptr(false), ReadOnlyHint: false, IdempotentHint: true, DestructiveHint: ptr(false), Title: "Update theme"}}, updateThemeHandler(api))
