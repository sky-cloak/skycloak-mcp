...
func registerReadParityTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "Get realm"},
	}, getRealmHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_get_application",
		Description: "Get an application (OIDC/SAML client) by client ID.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "Get application"},
	}, getApplicationHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_get_identity_provider",
		Description: "Get an identity provider by provider ID.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "Get identity provider"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List cluster locations"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List cluster types"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List cluster features"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List cluster versions"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List cluster upgrades"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List IdP templates"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List domain routes"},
...
type ClusterTypeInput struct {
	Type string `json:"type" jsonschema:"cluster type: keycloak or tidecloak"`
}
...
func listClusterVersionsHandler(api API) mcp.ToolHandlerFor[ClusterTypeInput, VersionsOutput] {
	return func(ctx context.Context, _ *mcp.CallToolRequest, in ClusterTypeInput) (*mcp.CallToolResult, VersionsOutput, error) {
		...
		versions, err := api.ClusterTypeVersions(ctx, in.Type)
		if err != nil {
