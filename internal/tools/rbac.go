...
func registerRBACReadTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List realm roles"},
	}, listRealmRolesHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_list_realm_groups",
		Description: "List the top-level groups in a realm.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List realm groups"},
	}, listRealmGroupsHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_list_realm_users",
		Description: "List the users in a realm.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List realm users"},
	}, listRealmUsersHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_get_realm_user",
		Description: "Get a realm user by ID.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "Get realm user"},
...
func registerRBACWriteTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), Title: "Create realm role"},
	}, createRealmRoleHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_delete_realm_role",
		Description: "Delete a realm role. Set confirm=true to proceed.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(true), Title: "Delete realm role"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), Title: "Create realm group"},
	}, createRealmGroupHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_delete_realm_group",
		Description: "Delete a realm group. Set confirm=true to proceed.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(true), Title: "Delete realm group"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), Title: "Create realm user"},
	}, createRealmUserHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_delete_realm_user",
		Description: "Delete a realm user. Set confirm=true to proceed.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(true), Title: "Delete realm user"},
	}, deleteRealmUserHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_assign_realm_user_role",
		Description: "Assign a realm role to a user.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), IdempotentHint: true, Title: "Assign user role"},
	}, assignRealmUserRoleHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_remove_realm_user_role",
		Description: "Remove a realm role from a user.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(true), IdempotentHint: true, Title: "Remove user role"},
	}, removeRealmUserRoleHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_add_realm_user_to_group",
		Description: "Add a user to a realm group.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), IdempotentHint: true, Title: "Add user to group"},
	}, addRealmUserToGroupHandler(api))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "skycloak_remove_realm_user_from_group",
		Description: "Remove a user from a realm group.",
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(true), IdempotentHint: true, Title: "Remove user from group"},
