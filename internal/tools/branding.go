...
func registerBrandingReadTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List themes"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "Get theme assignment"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "Get login branding"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "Get email branding"},
...
func registerBrandingWriteTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), IdempotentHint: true, Title: "Set theme assignment"},
