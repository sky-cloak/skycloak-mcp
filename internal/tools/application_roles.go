...
func registerApplicationRoleReadTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List application roles"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List application sessions"},
...
func registerApplicationRoleWriteTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), IdempotentHint: true, Title: "Assign application role"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(true), IdempotentHint: true, Title: "Remove application role"},
