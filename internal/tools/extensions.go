...
func registerExtensionReadTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List extension catalog"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: true, Title: "List installed extensions"},
...
func registerExtensionWriteTools(s *mcp.Server, api API) {
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), Title: "Install extension"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(false), IdempotentHint: true, Title: "Upgrade extension"},
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Annotations: &mcp.ToolAnnotations{ReadOnlyHint: false, DestructiveHint: ptr(true), Title: "Uninstall extension"},
